...
std::vector<Vector> NelderMeadOptimizer::optimize(const Domain& domain, int degree,
    ...
    std::cout
        << "NelderMeadOptimizer: optimization not fully implemented, returning initial nodes.\n";
    return nodes;
}
