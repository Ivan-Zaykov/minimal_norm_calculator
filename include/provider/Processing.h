...
class Processing {
    static int processHadamardMatrixFromFile(const std::string& filename, const ProgramOptions& opts,
                                               double& globalMin, int& globalMinMatrixIdx,
                                               Eigen::RowVectorXd& globalMinPoint);
    static int processSimplexFromFile(const ProgramOptions& opts);
    static double processHadamardMatrix(const Eigen::MatrixXd& H, const ProgramOptions& opts, int matrixCounter);
public:
